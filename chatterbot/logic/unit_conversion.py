...
from chatterbot1.conversation import Statement
from chatterbot1.exceptions import OptionalDependencyImportError
from chatterbot1 import languages
from chatterbot1 import parsing
...
class UnitConversion(LogicAdapter):
    ...
    :kwargs:
        * *language* (``object``) --
        The language is set to ``chatterbot1.languages.ENG`` for English by default.
    """
