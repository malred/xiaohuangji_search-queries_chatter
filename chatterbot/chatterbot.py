import logging
from chatterbot1.storage import StorageAdapter
from chatterbot1.logic import LogicAdapter
from chatterbot1.search import IndexedTextSearch
from chatterbot1 import utils
...
class ChatBot(object):
    ...
    def __init__(self, name, **kwargs):
        ...
        storage_adapter = kwargs.get('storage_adapter', 'chatterbot1.storage.SQLStorageAdapter')

        logic_adapters = kwargs.get('logic_adapters', [
            'chatterbot1.logic.BestMatch'
        ])
        ...
        preprocessors = kwargs.get(
            'preprocessors', [
                'chatterbot1.preprocessors.clean_whitespace'
            ]
        )
    ...
    def get_latest_response(self, conversation):
        ...
        """
        from chatterbot1.conversation import Statement as StatementObject
